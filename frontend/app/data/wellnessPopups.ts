...
export const orbitItems: OrbitItem[] = [
  {
    ...
    popup: {
      ...
      intro: [
        "The Australian Government confirms that water is the best drink for children of all ages and should be available at all times. Tap water is free, widely available, and fluoridated in most Australian communities for oral health.",
      ...
      tips: [
        ...
        {
          label: "Fussy drinker?",
          text: "Try adding different-shaped ice cubes to make water more fun for young children.",
        },
        {
      ...
      sources: ["health.gov.au", "betterhealth.vic.gov.au", "raisingchildren.net.au"],
    },
  },

  {
    ...
    popup: {
      ...
      subtitle: "A WELL-RESTED CHILD IS AN ACTIVE CHILD — AND AN ACTIVE CHILD SLEEPS BETTER",
      intro: [
        "Getting enough good-quality sleep is essential to healthy growth. Adequate sleep supports brain development, emotional regulation, physical growth, and immune health in children.",
      ],
      tableTitle: "How much sleep does my child need each night?",
      table: {
        headers: ["Toddlers (1–2 years)", "Preschoolers (3–5 years)", "Primary School (5–13 years)", "Teenagers (14–17)"],
        values: ["11–14 hrs", "10–13 hrs", "9–11 hrs", "8–10 hrs"],
      },
      tips: [
        {
          label: "Free tip",
          text: "Keep the same bedtime and wake-up time every day, including weekends.",
        },
        {
...

  {
    ...
    popup: {
      ...
      subtitle: "FROZEN AND CANNED VEGETABLES ARE JUST AS NUTRITIOUS — AND MUCH CHEAPER",
      intro: [
      ...
      table: {
        headers: ["Toddlers (1–3 years)", "Preschoolers (3–8 years)", "Primary School (9–11 years)", "Teenagers (12–18)"],
      ...
      sources: ["raisingchildren.net.au", "eatforhealth.gov.au", "betterhealth.vic.gov.au"],
    },
  },

  {
    ...
    popup: {
      ...
      intro: [
        "Fruit provides essential vitamins, minerals, fibre, and energy for growing children. Eating fruit regularly helps children have the energy they need to play, concentrate better, learn, and sleep better.",
      ],
      tableTitle: "How many serves of fruit per day?",
      table: {
        headers: ["Toddlers (1–2 years)", "Preschoolers (2–3 years)", "Primary School (4–8 years)", "Teenagers (9–18)"],
        values: ["½ serve", "1 serve", "1½ serves", "2 serves"],
      },
      tips: [
        {
          label: "Skip the juice",
          text: "Whole fruit is better than juice — it keeps the fibre, satisfies hunger, and has no extra sugar. Fruit juice adds cost without the benefit.",
        },
        {
          label: "Lunchbox idea",
...

  {
    ...
    popup: {
      ...
      subtitle: "YOU DON’T NEED EXPENSIVE FOOD TO EAT WELL — YOU NEED VARIETY FROM FIVE KEY FOOD GROUPS",
      intro: [
      ...
      table: {
        headers: ["Vegetables & Legumes", "Fruits", "Grains & Cereals", "Lean Proteins", "Dairy"],
        values: ["Fresh, frozen or canned", "Fresh, canned in juice or frozen", "Oats, bread, rice, pasta", "Eggs, tuna, chicken, tofu", "Milk, yoghurt, cheese"],
      },
      tips: [
        {
        ...
        {
          label: "Lunchbox idea",
          text: "Lunchboxes should reflect the Five Food Groups — a sandwich, a piece of fruit, some vegetable sticks, and water. Simple and affordable.",
        },
      ],
      imageSrc: "/images/wellness/popups/food-variety.webp",
      imageAlt: "Five food groups",
...

  {
    ...
    popup: {
      ...
      subtitle: "ACTIVE PLAY AT THE PARK COSTS NOTHING. IT IS ONE OF THE BEST THINGS YOU CAN DO FOR YOUR CHILD",
      intro: [
      ...
      table: {
        headers: ["Infants (0–12 months)", "Toddlers (1–3 years)", "Preschoolers (3–5 years)", "Children & Teens (5–17 years)"],
        values: ["Active play + 30 min tummy time", "At least 3 hrs/day", "3 hrs incl. 1 hr energetic play", "At least 60 min/day"],
      },
      tips: [
        {
          label: "Single parent tip",
...

  {
    ...
    popup: {
      ...
      subtitle: "EGGS, FISH, LEGUMES ARE AMONG THE CHEAPEST PROTEINS AVAILABLE — AND JUST AS NUTRITIOUS",
      intro: [
      ...
      tableTitle: "Affordable protein options:",
      table: {
        headers: ["Eggs", "Canned Tuna or Salmon", "Canned Legumes", "Frozen Chicken", "Tofu"],
        values: ["Cheap, versatile & nutrient-rich", "High in omega-3", "High in iron", "Affordable, rich in lean protein", "Plant-based, iron & calcium"],
      },
      tips: [
        {
...

  {
    ...
    popup: {
      ...
      subtitle: "HEALTHIER COOKING FATS ARE AVAILABLE — AND SWAPPING THEM IS EASIER THAN YOU THINK",
      intro: [
      ...
      table: {
        ...
        values: [
          ...
          "Olive oil, canola oil, nut butters, sunflower seeds, flax seeds, avocado, sesame seeds, soybeans, most nuts, rice bran, fish, lean meat.",
        ],
      },
...

  {
    ...
    popup: {
      ...
      subtitle: "ADDED SUGAR ADDS COST, KILOJOULES AND HEALTH RISK — WITH NO NUTRITIONAL BENEFIT",
      intro: [
      ...
      alertHtml:
        "Australian research found children who consumed more than one sugary drink per day were <span class='alert-red'>26% more likely</span> to be overweight or obese.",
      commonTitle: "Common hidden sources:",
      commonChips: true,
      commonSources: ["Soft drinks & cordials", "Cereals & yoghurt", "Biscuits & cakes", "Sauces & snack bars", "Chocolates & lollies"],
      commonTitle: "COMMON HIDDEN SOURCES:",
      commonItems: [
        {
      ...
      tips: [
        ...
        {
          label: "Sweet swap",
          text: "Seasonal fruit or frozen berries are cheap and better for your teeth.",
        },
      ],
...

  {
    ...
    popup: {
      ...
      subtitle: "SOFT DRINKS, SPORTS DRINKS, CORDIALS: NONE OF THEM NECESSARY FOR A CHILD’S HEALTH",
      intro: [
        "Limit all sugar-sweetened drinks for children including soft and energy drinks, cordials, fruit drinks, flavoured milks, and vitamin-style waters. There is strong evidence of a link between sugary drink consumption and excess weight gain, tooth decay, and reduced bone strength in children.",
      ],
      tableTitle: "What are the best drinks for children?",
      table: {
        headers: ["Under 12 months", "12 months–2 years", "2 years and older", "All ages (Avoid)"],
        values: ["Breast milk or infant formula", "Full-fat cow’s milk and tap water", "Reduced-fat milk and tap water", "Soft drinks, sports drinks"],
      },
      tips: [
        {
          label: "Transition tip",
          text: "If your child is used to sweet drinks, gradually dilute drinks with more water over time until they are happy with plain water.",
        },
        {
          label: "Lunchbox idea",
          text: "Water is the only recommended drink in school lunchboxes — a reusable bottle from the tap is free and the healthy choice.",
        },
      ],
...

  {
    ...
    popup: {
      ...
      subtitle: "ADDED FAST FOOD COSTS MONEY AND MORE HEALTH RISKS — COOKING AT HOME WINS BOTH WAYS",
      intro: [
      ...
      commonChips: true,
      commonSources: ["Fried chips & burgers", "Pizza and burgers", "Breads & fried buns", "Ice creams & sundaes", "Instant noodles"],
      commonTitle: "COMMON SOURCES:",
      commonItems: [
        {
...

  {
    ...
    popup: {
      ...
      subtitle: "SCREEN TIME LIMITS COST NOTHING TO ENFORCE — BENEFITS FOR YOUR CHILD ARE ENORMOUS",
      intro: [
        "Sedentary screen time can have long-term impacts on a child’s development, sleep, physical health, and mental wellbeing. Less screen time is linked to healthier body weight too.",
      ],
      tableTitle: "Maximum recommended sedentary recreational screen time per day:",
      table: {
        headers: ["Under 2 years", "2–5 years", "5–17 years"],
        values: ["No screen time at all", "No more than 1 hour per day", "No more than 2 hours per day"],
      },
      tips: [
        {
          label: "Free strategy",
      ...
      note: "School-related screen use is not included in these limits.",
...

  {
    ...
    popup: {
      category: "DON’T",
      title: "HIDDEN SALT: Check Packaged Foods",
      subtitle: "SALT HIDES IN MANY EVERYDAY PACKAGED FOODS",
      intro: [
        "Many packaged foods contain more salt than families realise. Choosing lower-salt options can support long-term heart health and healthier eating habits.",
      ],
      commonTitle: "Common hidden sources:",
      commonChips: true,
      alertHtml:
      ...
      commonSources: ["Instant noodles", "Processed meats", "Chips", "Packet soups", "Sauces"],
      commonTitle: "COMMON HIDDEN SOURCES:",
      commonItems: [
        {
      ...
      tips: [
        {
          label: "Label reading",
          text: "Compare products and choose lower-sodium options when possible.",
        },
        {
          label: "Easy swap",
          text: "Use herbs, garlic, lemon, or spices for flavour instead of adding extra salt.",
        },
      ],
      imageSrc: "/images/wellness/popups/hidden-salt.webp",
      imageAlt: "Salt and packaged foods",
      sources: ["betterhealth.vic.gov.au", "eatforhealth.gov.au"],
    },
  },

  {
    ...
    popup: {
      ...
      subtitle: "REGULAR DINNER TIME — ONE OF THE BEST THINGS YOU CAN DO FOR YOUR CHILD’S HEALTH",
      intro: [
      ...
      alertHtml:
        "The Better Health Channel states that not enough sleep can affect children's <span class='alert-red'>behaviour</span>, <span class='alert-red'>academics</span>, <span class='alert-red'>concentration</span>, and <span class='alert-red'>mood</span>.",
      commonTitle: "What disrupts sleep & triggers late snacking:",
      commonChips: true,
      commonSources: ["Screen blue light in bedroom", "Irregular meal & snack times", "Sugary foods close to bedtime", "Caffeine in chocolates"],
      commonTitle: "What disrupts sleep & triggers late snacking:",
      commonItems: [
        {
